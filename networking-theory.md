...
This README contains the provided networking questions and their answers formatted for easy reading. Each question is highlighted as a heading and the original answers are preserved exactly as given. Questions are separated from one another.
...
(Each question below is separated and the original answers are preserved.)
...
Internet	        • The internet layer is the most important layer which holds the whole architecture together.
...
(The following questions and answers are preserved exactly as provided.)
